...
function Footer() {
    return (
        <section className=" bg-slate-100">
            <div className=" font-medium text-black text-2xl text-center pt-10">
                <p>Do you want to be among the first to know
                </p>
                <p> about sale time?
                </p>
            ...
            <div className="hero bg-slate-100">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500  border-2   border-sky-800 ">
                        <form className="card-body ">
                            ...
                            <div className="form-control mt-6">
                                <button className="btn btn-secondary hover:btn-error">Login</button>
                            </div>
                        </form>
                    </div>
            ...
            <footer className="footer flex justify-between p-10 bg-gray-800 text-base text-red-500">
                <div>
            ...
            <footer className="footer p-4 bg-slate-200  text-emerald-500">
                <div className="container flex justify-between mx-auto ">
                    ...
                    <nav className=" flex gap-4 md:place-self-center md:justify-self-end">
                        ...
                        <a><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" className=" fill-blue-600" width="24"><rect fill="none" height="24" width="24" /><path d="M22,12c0-5.52-4.48-10-10-10S2,6.48,2,12c0,4.84,3.44,8.87,8,9.8V15H8v-3h2V9.5C10,7.57,11.57,6,13.5,6H16v3h-2 c-0.55,0-1,0.45-1,1v2h3v3h-3v6.95C18.05,21.45,22,17.19,22,12z" /></svg></a>
                    </nav>
                </div>
            </footer>
